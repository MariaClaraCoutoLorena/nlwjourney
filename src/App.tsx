        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape">
            ...
            <div className='flex items-center gap-2 flex-1'>
              ...
              <input disabled={isGuestsInputVisible} type="text" placeholder="Para onde você vai?" className="flex-1 pr-4 bg-transparent text-lg placeholder-zinc-400 outline-none"/>
            </div>

            <div className='flex items-center gap-2'>
              <Calendar className='size-5 text-zinc-400'/>
              <input disabled={isGuestsInputVisible} type="text" placeholder="Quando? " className="w-32 bg-transparent text-lg placeholder-zinc-400 outline-none pr-4"/>
            </div>
...

            {
              isGuestsInputVisible? (
                <button onClick={hideGuestsInput} className='bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700'>
                  Alterar local/data
                  <Settings2 className='size-5'/>
                </button>
              ) : (
                <button onClick={showGuestsInput} className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400'>
                  Continuar
...

          {
            isGuestsInputVisible && (
              <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape">
                ...
                <button onClick={showGuestsModal} className='flex items-center gap-2 flex-1 text-left'>
            ...
            <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
              ...
              <div className='space-y-2'>
                <div className='flex items-center justify-between'>
                  ...
                  <button onClick={hideGuestsModal}>
              ...
              <form onSubmit={addEmailToInvite} className='p-2.5 bg-zinco-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
